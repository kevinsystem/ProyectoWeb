...
namespace proyectokevin.Controllers
{
    public class tipo_habitacionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,tih_codigo,tih_descripcion")] tipo_habitacion tipo_habitacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,tih_codigo,tih_descripcion")] tipo_habitacion tipo_habitacion)
        {
            if (ModelState.IsValid)
            {
